...
public final class Sources {
    ...
    public static <K, V> BatchSource<Entry<K, V>> map(@Nonnull String mapName) {
        return batchFromProcessor("mapSource(" + mapName + ')', SourceProcessors.readMapP(mapName));
    }
    ...
    public static <T, K, V> BatchSource<T> map(
        ...
        return batchFromProcessor("mapSource(" + mapName + ')', SourceProcessors.readMapP(mapName, predicate, projection));
    }
...
*                     {@linkplain Processor#isCooperative() cooperative}.
    ...
    public static <T, K, V> StreamSource<T> mapJournal(
        ...
        return streamFromProcessorWithWatermarks("mapJournalSource(" + mapName + ')',
                false, w -> SourceProcessors.streamMapP(mapName, predicateFn, projectionFn, initialPos, w));
    }
    ...
    public static <K, V> StreamSource<Entry<K, V>> mapJournal(
        ...
        return mapJournal(mapName, initialPos, Util.mapEventToEntry(), Util.mapPutEvents());
    }
    ...
    public static <K, V> StreamSource<Entry<K, V>> mapJournal(
        ...
        return mapJournal(map.getName(), initialPos, Util.mapEventToEntry(), Util.mapPutEvents());
    }
    ...
    public static <T> BatchSource<T> list(@Nonnull String listName) {
        return batchFromProcessor("listSource(" + listName + ')', SourceProcessors.readListP(listName));
    }
    ...
    public static StreamSource<String> socket(
        ...
        return streamFromProcessor(
                "socketSource(" + host + ':' + port + ')', SourceProcessors.streamSocketP(host, port, charset)
        );
    }
