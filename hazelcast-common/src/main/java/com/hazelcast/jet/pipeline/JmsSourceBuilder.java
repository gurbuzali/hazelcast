...
public final class JmsSourceBuilder {
    ...
    public <T> StreamSource<T> build(@Nonnull FunctionEx<? super Message, ? extends T> projectionFn) {
        ...
        FunctionEx<EventTimePolicy<? super T>, ProcessorMetaSupplier> metaSupplierFactory =
                policy -> isTopicLocal
                        ? SourceProcessors.streamJmsTopicP(newConnectionFn, consumerFnLocal, isSharedConsumerLocal, messageIdFnLocal,
                                projectionFn, policy, maxGuaranteeFinal)
                        : SourceProcessors.streamJmsQueueP(newConnectionFn, consumerFnLocal, messageIdFnLocal, projectionFn, policy,
                                maxGuaranteeFinal);
