...
public final class Sinks {
    ...
    public static <T, K, V> Sink<T> map(
        ...
        return new SinkImpl<>("mapSink(" + mapName + ')',
                SinkProcessors.writeMapP(mapName, toKeyFn, toValueFn), toKeyFn);
    }
    ...
    public static <T, K, V> Sink<T> mapWithMerging(
        ...
        return new SinkImpl<>("mapWithMergingSink(" + mapName + ')',
                SinkProcessors.mergeMapP(mapName, toKeyFn, toValueFn,  mergeFn), toKeyFn);
    }
    ...
    public static <T, K, V> Sink<T> mapWithUpdating(
        ...
        return new SinkImpl<>("mapWithUpdatingSink(" + mapName + ')',
                SinkProcessors.updateMapP(mapName, toKeyFn, updateFn), toKeyFn);
    }
    ...
    public static <E, K, V, R> Sink<E> mapWithEntryProcessor(
        ...
        return fromProcessor("mapWithEntryProcessorSink(" + mapName + ')',
                SinkProcessors.updateMapP(mapName, toKeyFn, toEntryProcessorFn),
                toKeyFn);
    }
    ...
    public static <E, K, V, R> Sink<E> mapWithEntryProcessor(
        ...
        return fromProcessor("mapWithEntryProcessorSink(" + mapName + ')',
                SinkProcessors.updateMapP(maxParallelAsyncOps, mapName, toKeyFn, toEntryProcessorFn),
                toKeyFn);
    }
    ...
    public static <T extends Entry> Sink<T> cache(@Nonnull String cacheName) {
        ...
        return new SinkImpl<>("cacheSink(" + cacheName + ')', SinkProcessors.writeCacheP(cacheName), en -> en.getKey());
    }
    ...
    public static <T> Sink<T> list(@Nonnull String listName) {
        return fromProcessor("listSink(" + listName + ')', SinkProcessors.writeListP(listName));
    }
    ...
    public static <T> Sink<T> socket(
        ...
        return fromProcessor("socketSink(" + host + ':' + port + ')', SinkProcessors.writeSocketP(host, port, toStringFn, charset));
    }
    ...
    public static <T> Sink<T> logger(@Nonnull FunctionEx<? super T, String> toStringFn) {
        return fromProcessor("loggerSink", DiagnosticProcessors.writeLoggerP(toStringFn));
    }
    ...
    public static <T> Sink<T> noop() {
        return fromProcessor("noop", ProcessorMetaSupplier.preferLocalParallelismOne(Processors.noopP()));
    }
