...
public final class WriteObservableP<T> extends AsyncHazelcastWriterP {
    ...
    private static final int MAX_BATCH_SIZE = InternalObservable.RINGBUFFER_MAX_BATCH_SIZE;
    ...
    public void init(@Nonnull Outbox outbox, @Nonnull Context context) {
        ...
        // configured
        ringbuffer = instance().getRingbuffer(InternalObservable.ringbufferName(observableName));
    }
